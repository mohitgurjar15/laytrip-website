...
var AddCardComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], AddCardComponent.prototype, "totalCard");
    __decorate([
        core_1.Output()
    ], AddCardComponent.prototype, "emitNewCard");
    __decorate([
        core_1.Output()
    ], AddCardComponent.prototype, "changeLoading");
    __decorate([
        core_1.Output()
    ], AddCardComponent.prototype, "emitCardListChange");
    __decorate([
        core_1.Output()
    ], AddCardComponent.prototype, "add_new_card");
