...
exports.TravellersCrudComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var environment_1 = require("../../../../../../environments/environment");
var moment = require("moment");
var TravellersCrudComponent = /** @class */ (function () {
    function TravellersCrudComponent(formBuilder, genericService, router, commonFunction, flightService) {
    ...
    TravellersCrudComponent.prototype.ngOnInit = function () {
        this.checkUser();
        this.getCountry();
    ...
    TravellersCrudComponent.prototype.checkUser = function () {
        var userToken = localStorage.getItem('_lay_sess');
        if (userToken) {
            this.isLoggedIn = true;
        }
    };
    TravellersCrudComponent.prototype.getCountry = function () {
        var _this = this;
    ...
    TravellersCrudComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    TravellersCrudComponent.prototype.ngOnChanges = function (changes) {
        console.log('sdadddd', changes);
    };
    TravellersCrudComponent = __decorate([
        core_1.Component({
    ...
    return TravellersCrudComponent;
}());
exports.TravellersCrudComponent = TravellersCrudComponent;
