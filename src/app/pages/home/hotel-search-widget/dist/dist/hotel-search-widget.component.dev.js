...
var HotelSearchWidgetComponent =
/** @class */
function () {
  ...
  HotelSearchWidgetComponent.prototype.ngOnInit = function () {
    ...
    window.scrollTo(0, 0); // this.checkInDate = moment(this.customStartDateValidation).toDate();
  ...
  HotelSearchWidgetComponent.prototype.setHotelDate = function () {
    ...
    if (curretdate < customStartDate && daysDiff > 30) {
      ...
      this.checkInMinDate = this.checkInDate; // this.departureDate = date; 
    } else {
      this.checkInDate = moment(curretdate).add(31, 'days').toDate();
      this.checkInMinDate = this.checkInDate; // this.flightDepartureMinDate =  date;
    }
  };
  ...
  HotelSearchWidgetComponent.prototype.searchHotels = function () {
    ...
    var queryParams = {}; // var encode = encodeURIComponent(JSON.stringify(this.searchHotelInfo.location));
    ...
    queryParams.check_out = moment(this.rangeDates[1]).isValid() ? moment(this.rangeDates[1]).format('YYYY-MM-DD') : moment(this.rangeDates[0]).add(1, 'days').format('YYYY-MM-DD'); // queryParams.check_out = moment(this.rangeDates[1]).format('YYYY-MM-DD');
    ...
    if (this.validSearch && this.searchHotelInfo && this.searchHotelInfo.latitude && this.searchHotelInfo.longitude && this.searchHotelInfo.check_in && this.searchHotelInfo.check_out && this.searchHotelInfo.occupancies) {
      this.router.navigateByUrl('/', {
        skipLocationChange: true
      }).then(function () {
        _this.router.navigate(['hotel/search'], {
  ...
  __decorate([core_1.ViewChild('dateFilter',
  /* TODO: add static flag */
  undefined)], HotelSearchWidgetComponent.prototype, "dateFilter");

  HotelSearchWidgetComponent = __decorate([core_1.Component({
