...
var confirmation_modal_component_1 = require("src/app/components/confirmation-modal/confirmation-modal.component");
var environment_1 = require("../../../environments/environment");
var ShareSocialMediaComponent = /** @class */ (function () {
    function ShareSocialMediaComponent(activeModal) {
        this.activeModal = activeModal;
        this.s3BucketUrl = environment_1.environment.s3BucketUrl;
        this.url = 'https://staging.laytrip.com';
    }
    ...
    ShareSocialMediaComponent.prototype.share = function (media) {
        if (media == 'Pinterest') {
            ...
            window.open('https://www.facebook.com/sharer/sharer.php?u=' + escape(this.url) + '&t=' + document.title, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
        }
