...
var CheckoutComponent =
    ...
    function() {
        function CheckoutComponent(genericService, travelerService, checkOutService, cartService, cookieService, cd, router, commonFunction, route, modalService, spreedly) {
            ...
            this.modules = []; //this.totalLaycredit();

            this.getCountry(); // this.openBookingCompletionErrorPopup();
        }
        ...
        CheckoutComponent.prototype.ngOnInit = function() {
            ...
            this.cartService.getCartList('yes').subscribe(function(items) {
                ...
                for (var i = 0; i < items.data.length; i++) {
                    ...
                    if (_this.modules.some(function(x) {
                            return x === "flight";
                        })) {
            ...
            this.cartService.deleteCartItem(cartId).subscribe(function(res) {
                ...
                if (this.commonFunction.isRefferal()) {
                    ...
                    this.router.navigate(['/cart/checkout'], {
                        skipLocationChange: true,
                        queryParams: {
                            utm_source: parms.utm_source,
                            utm_medium: parms.utm_medium
                        }
                    });
                } else {
                ...
                var index = _this.carts.findIndex(function(x) {
                    return x.id == cartId;
                });
        ...
        CheckoutComponent.prototype.bookFlight = function() {
            ...
            var carts = this.carts.map(function(cart) {
                return {
                    cart_id: cart.id
                };
            });
            ...
            if (this.isValidTravelers && this.cardToken != '' && this.isAllAlertClosed && this.isTermConditionAccepted && this.isExcludedCountryAccepted) {
                ...
                var _loop_1 = function _loop_1(i) {
                    var data = this_1.travelerForm.controls["type" + i].value.adults; //let travelers = data.map(traveler => { return { traveler_id: traveler.userId } })
        ...
        CheckoutComponent.prototype.totalNumberOfcard = function(event) {
            console.log(event); //this.totalCard = event;
        };
        ...
        __decorate([core_1.ViewChild(add_card_component_1.AddCardComponent, {
            "static": false
