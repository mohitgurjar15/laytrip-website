...
var AccountService = /** @class */ (function () {
    ...
    AccountService.prototype.getIncomplteBooking = function (search) {
        return this.http.get(environment_1.environment.apiUrl + "v1/booking/incomplete-bookings?search=" + search, this.commonFunction.setHeaders())
            .pipe(operators_1.catchError(this.handleError));
    };
    AccountService.prototype.getComplteBooking = function (search) {
